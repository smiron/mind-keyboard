...
namespace EmoEngineClientLibrary
{
    ...
    /// using the <see cref=".EE_DataChannel_t"/> enumeration. Realtime data samples from the 
    /// neuroheadset arrive in arrays of type <c>double</c>. A data frame comprises
    /// all of the channels defined in the <see cref=".EE_DataChannel_t"/> enumeration mapped 
    ...
    /// </para>
    /// </remarks>
    public class SampleBufferDictionary : Dictionary<EE_DataChannel_t, double[]>
    {
        ///////////////////////////////////////////////////////////////////////
        ...
        public long TotalSamples
        {
            get
            {
                ...
                return this.TotalFrames * this[EE_DataChannel_t.AF3].Length;
            }
        }
        ...
        /// </summary>
        public Dictionary<EE_DataChannel_t, double> ChannelAverages
        {
            get
            {
                if( this._channelAverages == null )
                {
                    this._channelAverages = new Dictionary<EE_DataChannel_t, double>();
                }
        ...
        /// </summary>
        //public Dictionary<.EE_DataChannel_t, double[]> FastFourierTransforms
        //{
        //    get
        //    {
        //        if( this._FFTs == null )
        //        {
        //            this._FFTs = new Dictionary<.EE_DataChannel_t, double[]>();
        //        }
        ...
        /// are excluded, but some signals, such as <see cref=".EE_DataChannel_t.COUNTER"/>, 
        /// are usually included for diagnostic purposes.
        /// </para>
        /// </remarks>
        public void Add( Dictionary<EE_DataChannel_t, double[]> dataFrame )
        {
            ...
            if( dataFrame != null )
            {
                ...
                int sampleCount = dataFrame[EE_DataChannel_t.AF3].Length;
                ...
                lock( this._lockThis )
                {
                    ...
                    foreach( KeyValuePair<EE_DataChannel_t, double[]> kvp in dataFrame )
                    {
                        ...
                        if( addToBuffer )
                        {
                            ...
                            if( kvp.Key == EE_DataChannel_t.COUNTER )
                            {
                            ...
                            if( samplesToBufferEnd >= newSamples.Length )
                            {
                                ...
                                if( samplesToBufferEnd == newSamples.Length )
                                {
                                    ...
                                    BufferFilledEventArgs bfea = new BufferFilledEventArgs( bufferD, kvp.Key );
        ...
        /// </remarks>
        public double[] ComputeRealFourierTransform( EE_DataChannel_t channel )
        {
        ...
        private static Complex[] ComputeFourierTransform( EE_DataChannel_t channel, double[] data )
        {
        ...
        public Complex[] ComputeFourierTransform( EE_DataChannel_t channel )
        {
        ...
        /// </summary>
        private Dictionary<EE_DataChannel_t, double> _channelAverages;

        /// <summary>
        /// The dictionary of contains the Fast Fourier Transform (FFT) for each channel.
        /// </summary>
        //private Dictionary<.EE_DataChannel_t, double[]> _FFTs;
