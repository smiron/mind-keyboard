...
namespace EmoEngineClientLibrary
{
    ...
    /// </para>
    /// <para>
    /// Each frame contains data for the channels specified in the <see cref=".EE_DataChannel_t"/> 
    ...
    public class SampleBuffer
    {
        ...
        private Dictionary<EE_DataChannel_t, double> _averages;
        ...
        public Dictionary<EE_DataChannel_t, double> ChannelAverages
        {
            get
            {
                ...
                {
                    this._averages = new Dictionary<EE_DataChannel_t, double>();
                }
        ...
        /// </remarks>
        public void AddFrame( Dictionary<EE_DataChannel_t, double[]> dataFrame )
        {
