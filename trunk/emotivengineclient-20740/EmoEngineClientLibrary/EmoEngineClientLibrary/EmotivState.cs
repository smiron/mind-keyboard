...
{   
    ...
    public class EmotivState
    {
        ...
        /// </summary>
        public EE_CognitivAction_t CognitivCurrentAction
        {
            get
            {
        ...
        /// </summary>
        public EE_ExpressivAlgo_t ExpressivLowerFaceAction
        {
            get
            {
        ...
        /// </summary>
        public EE_ExpressivAlgo_t ExpressivUpperFaceAction
        {
            get
            {
        ...
        /// </summary>
        public EE_SignalStrength_t WirelessSignalStatus
        {
            get
            {
        ...
        public static Dictionary<int, EE_DataChannel_t> InputChannelIndexToDataChannelMap
        {
            get
            {
                // TBD: A bit hacky.
                Dictionary<EE_InputChannels_t, EE_DataChannel_t> d = InputChannelToDataChannelMap;

                return _inputChannelIndexToDataChannelMap;
            }
        }

        public static Dictionary<EE_InputChannels_t, EE_DataChannel_t> InputChannelToDataChannelMap
        {
            get
            {
                if( _inputChannelToDataChannelMap == null )
                {
                    _inputChannelToDataChannelMap = new Dictionary<EE_InputChannels_t, EE_DataChannel_t>();
                    _inputChannelIndexToDataChannelMap = new Dictionary<int, EE_DataChannel_t>();

                    Array inputChannels = Enum.GetValues( typeof( EE_InputChannels_t ) );

                    for( int i = 0; i < inputChannels.Length; i++ )
                    {
                        EE_InputChannels_t inputChannel = (EE_InputChannels_t)inputChannels.GetValue( i );

                        switch( inputChannel )
                        {
                            case EE_InputChannels_t.EE_CHAN_AF3:
                            {
                                _inputChannelToDataChannelMap[inputChannel] = EE_DataChannel_t.AF3;
                                _inputChannelIndexToDataChannelMap[i] = EE_DataChannel_t.AF3;
                                break;
                            }
                            case EE_InputChannels_t.EE_CHAN_AF4:
                            {
                                _inputChannelToDataChannelMap[inputChannel] = EE_DataChannel_t.AF4;
                                _inputChannelIndexToDataChannelMap[i] = EE_DataChannel_t.AF4;
                                break;
                            }
                            case EE_InputChannels_t.EE_CHAN_F3:
                            {
                                _inputChannelToDataChannelMap[inputChannel] = EE_DataChannel_t.F3;
                                _inputChannelIndexToDataChannelMap[i] = EE_DataChannel_t.F3;
                                break;
                            }
                            case EE_InputChannels_t.EE_CHAN_F4:
                            {
                                _inputChannelToDataChannelMap[inputChannel] = EE_DataChannel_t.F4;
                                _inputChannelIndexToDataChannelMap[i] = EE_DataChannel_t.F3;
                                break;
                            }
                            case EE_InputChannels_t.EE_CHAN_F7:
                            {
                                _inputChannelToDataChannelMap[inputChannel] = EE_DataChannel_t.F7;
                                _inputChannelIndexToDataChannelMap[i] = EE_DataChannel_t.F7;
                                break;
                            }
                            case EE_InputChannels_t.EE_CHAN_F8:
                            {
                                _inputChannelToDataChannelMap[inputChannel] = EE_DataChannel_t.F8;
                                _inputChannelIndexToDataChannelMap[i] = EE_DataChannel_t.F8;
                                break;
                            }
                            case EE_InputChannels_t.EE_CHAN_FC5:
                            {
                                _inputChannelToDataChannelMap[inputChannel] = EE_DataChannel_t.FC5;
                                _inputChannelIndexToDataChannelMap[i] = EE_DataChannel_t.FC5;
                                break;
                            }
                            case EE_InputChannels_t.EE_CHAN_FC6:
                            {
                                _inputChannelToDataChannelMap[inputChannel] = EE_DataChannel_t.FC6;
                                _inputChannelIndexToDataChannelMap[i] = EE_DataChannel_t.FC6;
                                break;
                            }
                            case EE_InputChannels_t.EE_CHAN_O1:
                            {
                                _inputChannelToDataChannelMap[inputChannel] = EE_DataChannel_t.O1;
                                _inputChannelIndexToDataChannelMap[i] = EE_DataChannel_t.O1;
                                break;
                            }
                            case EE_InputChannels_t.EE_CHAN_O2:
                            {
                                _inputChannelToDataChannelMap[inputChannel] = EE_DataChannel_t.O2;
                                _inputChannelIndexToDataChannelMap[i] = EE_DataChannel_t.O2;
                                break;
                            }
                            case EE_InputChannels_t.EE_CHAN_P7:
                            {
                                _inputChannelToDataChannelMap[inputChannel] = EE_DataChannel_t.P7;
                                _inputChannelIndexToDataChannelMap[i] = EE_DataChannel_t.P7;
                                break;
                            }
                            case EE_InputChannels_t.EE_CHAN_P8:
                            {
                                _inputChannelToDataChannelMap[inputChannel] = EE_DataChannel_t.P8;
                                _inputChannelIndexToDataChannelMap[i] = EE_DataChannel_t.P8;
                                break;
                            }
                            case EE_InputChannels_t.EE_CHAN_T7:
                            {
                                _inputChannelToDataChannelMap[inputChannel] = EE_DataChannel_t.T7;
                                _inputChannelIndexToDataChannelMap[i] = EE_DataChannel_t.T7;
                                break;
                            }
                            case EE_InputChannels_t.EE_CHAN_T8:
                            {
                                _inputChannelToDataChannelMap[inputChannel] = EE_DataChannel_t.T8;
                                _inputChannelIndexToDataChannelMap[i] = EE_DataChannel_t.T8;
                                break;
                            }
        ...
        public Dictionary<EE_DataChannel_t, EE_EEG_ContactQuality_t> ContactQualityFromAllChannels
        {
            get
            {
                Dictionary<EE_DataChannel_t, EE_EEG_ContactQuality_t> contactQualityDictionary =
                    new Dictionary<EE_DataChannel_t, EE_EEG_ContactQuality_t>();

                //Array enums = Enum.GetValues( typeof( .EE_InputChannels_t ) );
                //string[] enumNames = Enum.GetNames( typeof( .EE_InputChannels_t ) );
                //List<.EE_InputChannels_t> inputChannelEnums = new List<.EE_InputChannels_t>();

                EE_EEG_ContactQuality_t[] contactQualityArray = this._emoState.GetContactQualityFromAllChannels();

                for( int i = 0; i < contactQualityArray.Length; i++ )
                {
                    if( InputChannelIndexToDataChannelMap.ContainsKey( i ) )
                    {
                        EE_DataChannel_t channel = InputChannelIndexToDataChannelMap[i];
        ...
        public List<EE_EEG_ContactQuality_t> ContactQualityFromElectrodeChannels
        {
            get
            {
                //Array inputChannelEnums = Enum.GetValues( typeof( .EE_InputChannels_t ) );
                
                //.EE_EEG_ContactQuality_t[] contactQualityArray = this._emoState.GetContactQualityFromAllChannels();

                //// TBD: There really has to be a more elegant way of doing this with LINQ.
                //List<.EE_EEG_ContactQuality_t> electrodeContactQuality = contactQualityArray.ToList();

                //electrodeContactQuality.RemoveAt( 0 );  // .EE_InputChannels_t.EE_CHAN_CMS = 0
                //electrodeContactQuality.RemoveAt( 1 );  // .EE_InputChannels_t.EE_CHAN_DRL = 1
                //electrodeContactQuality.RemoveAt( 2 );  // .EE_InputChannels_t.EE_CHAN_FP1 = 2
                //electrodeContactQuality.RemoveAt( 17 ); // .EE_InputChannels_t.EE_CHAN_FP2 = 17
        ...
        //public List<.EE_EEG_ContactQuality_t> ContactQualityFromAllChannels
        //{
        //    get
        //    {
        //        .EE_EEG_ContactQuality_t[] contactQualityArray = this._emoState.GetContactQualityFromAllChannels();
        ...
        private static Dictionary<EE_InputChannels_t, EE_DataChannel_t> _inputChannelToDataChannelMap;
        private static Dictionary<int, EE_DataChannel_t> _inputChannelIndexToDataChannelMap;
